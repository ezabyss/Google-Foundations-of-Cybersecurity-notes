# 📘 Cybersecurity Glossary (Google Cybersecurity Certificate)

This file contains glossary terms from the Google Cybersecurity Certificate, organized **A–Z** in GitHub-compatible tables.
...
| NIST Incident Response Lifecycle | A framework for incident response consisting of four phases: Preparation; Detection and Analysis; Containment, Eradication and Recovery; and Post-incident activity. |
| NIST Special Publication (SP) 800-53 | A unified framework for protecting the security of information systems within the U.S. federal government. |
...
| Online presence | Your personal brand across all of your online activities. |
...
| STAR method | A storytelling framework that helps you communicate your experiences and skills in a clear, concise, and compelling way; stands for Situation, Task, Action, and Result. |
